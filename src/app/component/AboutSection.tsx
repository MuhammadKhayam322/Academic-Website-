...
const AboutSection: React.FC<AboutSectionProps> = ({
  ...
  return (
    <div className="flex justify-center items-center">
      <div className="flex flex-col justify-center relative mt-10 border rounded-2xl w-full max-w-[553px] h-auto md:h-[538px] bg-white shadow-md p-6">
        <div className="w-full">
          ...
          <div className="mt-28 px-4 md:px-10">
            ...
            <div className="w-fit mx-auto md:mx-0 h-12 border bg-red-100 mt-8 rounded-2xl px-6 flex items-center gap-2 cursor-pointer hover:bg-red-200 transition">
